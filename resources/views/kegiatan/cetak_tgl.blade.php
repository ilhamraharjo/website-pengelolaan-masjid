...
<div class="mb-3">
    ...
    <a href="" onclick="this.href='/kegiatan/cetak_pertanggal/'+ document.getElementById('tgl_awal').value + 
    '/' + document.getElementById('tgl_akhir').value" target="blank" class="btn btn-secondary mb-3">
